        ...
        while continue_:
            ...
            for i, node in enumerate(self.nodes):
                ...
                if tag == 'VP' and parent_tag != 'VP' and regular_vp:
                    ...
                    self.nodes[node]['name'] = 'VP[aspect={0},tense={1},voice={2},person={3},number={4}]'.format(aspect,
                                                                                                                 tense,
                                                                                                                 voice,
                                                                                                                 person,
                                                                                                                 number)
...
class TemplateExtraction:
    ...
    def classify_verb(self, tokens, lemmas, pos):
        ...
        w = 'VP[aspect={0},tense={1},voice={2},person={3},number={4}] {5}'.format(aspect, tense, voice, person, number,
                                                                                  lemmas[-1])
        return w
...
class Lexicalization(Preprocess):
    def __init__(self, data_path, write_path, stanford_path):
        super().__init__(data_path=data_path, write_path=write_path, stanford_path=stanford_path)
